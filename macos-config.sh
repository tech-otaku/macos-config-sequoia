...
# System Settings > Appearance > Accent Colour
    # Graphite
...
# System Settings > Appearance > Highlight colour
     # Accent Colour
...
# System Settings > Control Centre > Recent documents, applications and servers
    # GUI Scripting: ./Scripts/Config\ All.scpt <delay-interval>
